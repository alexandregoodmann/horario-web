  ...
  private criaOrigem(): void {
    ...
    lista.forEach(d => {
      d.turmas.forEach(t => {
        ...
        turma.codigoTurma = t.codigo;
        turma.horarios = t.horario;
        turma.nmDisciplina = d.nmNome;
        turma.sgCodCred = d.sgCodicred;
        this.origem.push(turma);
      });
    });
  }
